Describe 'New-JMuModule' {
    ...
    BeforeAll {
        ...
        $templateResult = $t | New-JMuModule -DestinationPath $templateTestModulePath @params | Select-Object -Last 1
        $noTemplateResult = New-JMuModule -DestinationPath $noTemplateTestModulePath @params | Select-Object -Last 1
    }
